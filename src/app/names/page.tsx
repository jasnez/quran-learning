...
export const metadata: Metadata = {
  title: "99 Allahovih imena | Quran Learning",
  description:
    "Al-Asmāʾ al-Ḥusnā – 99 Allahovih imena s arapskim tekstom, transliteracijom i prijevodom na bosanski.",
};
    ...
    <main className="min-h-screen px-4 pb-24 pt-16 md:py-12">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mb-8 text-stone-500 dark:text-stone-400">
          Al-Asmāʾ al-Ḥusnā – arapski, transliteracija i prijevod na bosanski
        </p>
        <NamesPageContent />
      </div>
    </main>
